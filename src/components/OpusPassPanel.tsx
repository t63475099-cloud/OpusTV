...
export default function OpusPassPanel({
  ...
  return (
    <section className="space-y-4 relative">
      ...
      <div className="rounded-2xl border border-[#27272a] bg-[#121212] p-3.5">
        ...
        <div className="mt-2.5 h-2 rounded-full bg-white/10 overflow-hidden">
          <div
            className="h-full rounded-full transition-all duration-700 bg-[#0084ff]"
      ...
      <div className="rounded-2xl border border-[#27272a] bg-[#121212] p-4 shadow-[0_8px_32px_rgba(0,0,0,0.35)]">
          ...
          <div className="flex flex-col items-end gap-2">
            {premium ? (
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-semibold px-3.5 py-2 rounded-full bg-[#0084ff] text-white active:scale-95 transition"
              >
        ...
        <div className="mt-3 h-2.5 rounded-full bg-white/10 overflow-hidden">
          <div
            className="h-full rounded-full transition-all duration-500 ease-out bg-[#0084ff]"
      ...
      <div className="rounded-2xl border border-[#27272a] bg-[#121212] p-3">
      ...
      <div className="rounded-2xl border border-[#27272a] bg-[#121212] overflow-hidden">
