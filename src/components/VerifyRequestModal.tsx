...
const REASONS = [
  "Tài khoản cá nhân thật",
  "Kênh nội dung / sáng tạo",
  "Cộng đồng / fanpage",
  "Bảo vệ thương hiệu tên",
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="px-4 sm:px-5 py-4 overflow-y-auto overscroll-contain"
          style={{ maxHeight: "calc(min(90dvh, 640px) - 64px)" }}
        >
          {verified ? (
