...
export const FEATURED_XIANXIA = [
  ...
  { slug: "tru-tien", name: "Tru Tiên" },
  { slug: "luu-ly-my-nhan-sat", name: "Lưu Ly Mỹ Nhân Sát" },
  ...
  { slug: "nghich-thien-chi-ton", name: "Nghịch Thiên Chí Tôn" },
...
export const NAV_CATEGORIES = [
  ...
  { name: "Tiên Hiệp", href: "/the-loai/co-trang" },
