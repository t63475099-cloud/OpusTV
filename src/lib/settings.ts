...
export const AVATAR_FRAMES: {
  ...
  src: string | null;
  effect: FrameEffect;
  /** SVG thứ 2 để morph (tùy chọn) */
  srcAlt?: string | null;
  color?: string;
}[] = [
  { id: "frame:none", label: "Không", src: null, effect: "none" },
  { id: "frame:top1", label: "TOP1 Vàng", src: "/frames/top1.svg", effect: "morph", srcAlt: "/frames/dragon.svg", color: "#f5a623" },
  { id: "frame:top2", label: "TOP2 Xanh", src: "/frames/top2.svg", effect: "orbit", color: "#3b82f6" },
  { id: "frame:top3", label: "TOP3 Đỏ", src: "/frames/top3.svg", effect: "pulse", color: "#ef4444" },
  { id: "frame:ice", label: "Băng tinh", src: "/frames/ice.svg", effect: "ice", color: "#22d3ee" },
  { id: "frame:darklord", label: "Ma vương", src: "/frames/darklord.svg", effect: "particle", color: "#f87171" },
  { id: "frame:knight", label: "Bạch kỵ sĩ", src: "/frames/knight.svg", effect: "spark", color: "#e7e5e4" },
  { id: "frame:dragon", label: "Long hoàng", src: "/frames/dragon.svg", effect: "flame", color: "#f59e0b" },
  { id: "frame:myth", label: "Thần thoại", src: "/frames/myth.svg", effect: "morph", srcAlt: "/frames/void.svg", color: "#a78bfa" },
  { id: "frame:jade", label: "Ngọc bích", src: "/frames/jade.svg", effect: "orbit", color: "#34d399" },
  { id: "frame:flame", label: "Hỏa diệm", src: "/frames/flame.svg", effect: "flame", color: "#fb923c" },
  { id: "frame:void", label: "Hư không", src: "/frames/void.svg", effect: "neon", color: "#e879f9" },
  { id: "frame:rainbow", label: "Cầu vồng", src: "/frames/top1.svg", effect: "rainbow", color: "#f472b6" },
  { id: "frame:sparkle", label: "Lấp lánh", src: "/frames/knight.svg", effect: "spark", color: "#fde68a" },
  { id: "frame:chaos", label: "Hỗn mang", src: "/frames/darklord.svg", effect: "particle", srcAlt: "/frames/flame.svg", color: "#f43f5e" },
  { id: "frame:aurora", label: "Cực quang", src: "/frames/ice.svg", effect: "neon", srcAlt: "/frames/myth.svg", color: "#67e8f9" },
];
